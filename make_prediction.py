...
materials = {
    # Steels
    "Steel S235": {
        "E": 210000.0, "nu": 0.30, #Young's modulus and Poisson's ratio
        "sigma_yield": 235.0, "sigma_uts": 360.0, #yield strength and ultimate tensile strength
        "ductile": True, "SF": 1.5, "SB": 2.5, #Safety factors for yield and ultimate tensile strength
        "tau_allow_key": 45.0, #allowable shear stress for keyed connections
        "p_allow_key":   70.0, #allowable bearing pressure for keyed connections
        "p_allow_spline": 55.0, #allowable bearing pressure for spline connections
        "category": "steel" #material category
    },
    "Steel C45": {
        "E": 210000.0, "nu": 0.30,
